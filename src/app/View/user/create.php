...
$newForm->formField(inputID: "email", inputName: "studentEmail", inputType: "text", inputClass: "form-control", inputPlaceholder: "Enter email:");
...
$newForm->formRadio(inputID: "frontend", inputName: "course", inputType: "radio", inputClass: "form-check-input", inputValue: "frontend");
...
$newForm->formRadio(inputID: "backend", inputName: "course", inputType: "radio", inputClass: "form-check-input", inputValue: "Backend");
...
$newForm->formRadio(inputID: "devops", inputName: "course", inputType: "radio", inputClass: "form-check-input", inputValue: "devops");
...
$newForm->formButton(buttonID: "submitButton", buttonName: "submitcreateUser", buttonType: "submit", buttonClass: "btn btn-sm btn-primary", buttonTitle: "Submit");
